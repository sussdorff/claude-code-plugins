...
Flags: `--dry-run`, `--skip-learnings`, `--skip-push`, `--skip-audit`, `--skip-simplify`, `--skip-debrief`, `--skip-summary`
...
bd create --title="Implement X" --type=task
bd create --title="Write tests for X" --type=task
bd dep add beads-yyy beads-xxx  # Tests depend on implementation
```
